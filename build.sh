...
cp ./fonts/fontawesome-mixed.ttf ./build
cp ./fonts/devicons-regular.ttf ./build

./scripts/fu-relocate ./fonts/octicons-regular.ttf --save-as='.work/octicons-regular-relocated.ttf' --from="0xf43e" --to='0xf7a0' 2> /dev/null
...
./scripts/fu-map ./build/fontawesome-mixed.ttf --namespace 'AWESOME' 2> /dev/null > ./build/fontawesome-mixed.sh
